// funzione per richiamare l'elenco regioni come suggerimento barra di ricerca
...
// funzione per indirizzare l'user alla pagina della regione cercata
function redirect() {
    var searchitem = document.getElementById("search");
    window.location.replace("http://127.0.0.1:5500/index-" + searchitem.value + ".html");
}

// funzione per ricevere dal json i dati della dati-table e mostrarli nella rispettiva html table
$(document).ready(function () {
...
// funzione per ricevere dal json i dati della regioni-table e mostrarli nella rispettiva html table
$(document).ready(function () {
...
// funzione per ricevere dal json i dati della recenti-table e mostrarli nella rispettiva html table
$(document).ready(function () {
...
// funzione per ricevere dal json i dati della programmate-table e mostrarli nella rispettiva html table
$(document).ready(function () {
...
// funzione per ricevere dal json i dati della veneto-table e mostrarli nella rispettiva html table
$(document).ready(function () {
...
// funzione per ricevere dal json i dati della lazio-table e mostrarli nella rispettiva html table
$(document).ready(function () {
...
// funzione per il sorting lazio-table  
...
// funzione per il sorting veneto-table  
...
// funzione per il sorting recenti-table  
...
// funzione per il sorting programmate-table  
